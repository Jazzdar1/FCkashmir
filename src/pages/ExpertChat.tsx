  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      sender: 'bot',
      text: "As-Salamu Alaykum! I'm Towseef Ahmad, your Kashmiri Agricultural Expert AI. How can I help you today? \n\n السلام علیکم! میں ہوں توصیف احمد، آپ کا کشمیری زرعی ماہر اے آئی۔ آج میں آپ کی کیا مدد کر سکتا ہوں؟",
      timestamp: new Date(),
    }
  ]);
    ...
    <div className="flex flex-col h-[calc(100vh-160px)] lg:h-[calc(100vh-120px)] animate-in fade-in zoom-in-95 duration-700">
      <header className="flex items-center justify-between mb-6 bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-heading font-bold text-slate-900 leading-none">Towseef Ahmad AI</h2>
