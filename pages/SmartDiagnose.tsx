...
const MetricBar = ({ label, value, colorClass, delay = 0 }: { label: string, value: number, colorClass: string, delay?: number }) => (
  <div className="space-y-2 animate-in fade-in slide-in-from-left-2 duration-500" style={{ animationDelay: `${delay}ms` }}>
...
const SmartDiagnose: React.FC = () => {
  ...
  const severityConfigs = {
    Low: { 
      ...
      metrics: { infection: 15, spread: 25, recovery: 90 }
    },
    Medium: { 
      color: 'amber', 
      label: 'Spreading', 
      ...
      lightBg: 'bg-amber-50',
      metrics: { infection: 55, spread: 65, recovery: 50 }
    },
    High: { 
      color: 'rose', 
      label: 'Critical', 
      ...
      lightBg: 'bg-rose-50',
      metrics: { infection: 95, spread: 90, recovery: 15 }
    }
  };
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 pb-20">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-heading font-bold text-slate-900">FCK Scanner Pro</h2>
          ...
          {!analysis && !loading && !error && (
            <div className="bg-white p-12 rounded-[3.5rem] border border-slate-100 shadow-sm text-center space-y-8 flex flex-col items-center justify-center min-h-[500px]">
              ...
              <div className="space-y-4 max-w-sm">
                <h4 className="text-2xl font-bold text-slate-900">FCK Scanner Active</h4>
              ...
              <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-2xl relative overflow-hidden">
                ...
                <div className="mb-10 bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200 space-y-8 relative">
                  <div className="flex items-center justify-between">
                    <h5 className="font-bold text-slate-900 flex items-center gap-2 text-lg">
                      <Activity className="w-6 h-6 text-emerald-600" /> Diagnostic Result Map
                    </h5>
                  </div>
                ...
                <div className="space-y-6 relative z-10">
                  <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100">
                    <h5 className="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-2">Analysis</h5>
                  ...
                  <div className="mt-8 border-t border-slate-100 pt-8">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-lg">Detailed AI Insights</span>
                      </div>
